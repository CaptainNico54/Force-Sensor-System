...
void doTare(uint8_t dt)
{
    ...
    delay((dt * 1000));  // Let things settle for dt seconds before reading.
...
void doCalibration()
{
    ...
    Serial.println(" Carefully hang a 1.0kg\n mass from the build plate");
    Serial.println(" Then, double-click the\n tare button to calibrate");
    ...
    // Inform the user via Serial what's happening
